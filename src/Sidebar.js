    ...
    return (
        <div className='sidebar'>
            <div className='sidebar__top'>
                ...
                />
                <SidebarRow 
                    url = "https://i.pinimg.com/originals/62/71/df/6271df0313418f138a64b8e2634812ad.png"
                    title = "Gaming video"
                />
                <SidebarRow 
            ...
            <div className='sidebar__bottom'>
                <div className='sidebar__bottom__title'>
                    <h3 style={{fontWeight: '400'}}>your shortcuts</h3>
                </div>
                <div className='sidebar__bottom__content'>
                    ...
                    />
                    <SidebarRow 
                        url = "https://scontent.fdac24-1.fna.fbcdn.net/v/t1.6435-1/c0.0.200.200a/p200x200/176891218_931837107630776_4765070299191786107_n.jpg?_nc_cat=102&ccb=1-3&_nc_sid=7206a8&_nc_ohc=_LOQDLQQtvcAX-bJGNM&_nc_ht=scontent.fdac24-1.fna&tp=27&oh=9b076bd2548d777b9c61a46a1d16206b&oe=60D8DAFE"
                        title = "Code With saju"
                    />
                    <SidebarRow 
                        url = "https://capitalscoalition.org/wp-content/uploads/2019/04/Flooded_haor.jpg"
                        title = "Accenture Bangladesh"
                    />
